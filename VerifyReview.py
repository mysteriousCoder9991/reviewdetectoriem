...
# file1=open("abc.txt",'w',encoding="utf")
'''id1=input("Enter id : \n")
s1=input("enter review : \n")
#file1.write(id1+'\t'+s1)
#file1.close()'''
...
for each_key, each_value in Test_Review_Dict.items():
    ...
    temp_dict.update({'True': Positive_Probability_Sentence})
    temp_dict.update({'False': Negative_Probability_Sentence})
    result = ""
    if Negative_Probability_Sentence > Positive_Probability_Sentence:
        print("Fake")
        result="Fake"
    else:
        print("Real")
        result="Real"
    fileResult=open("Result.txt","w",encoding="utf-8")
